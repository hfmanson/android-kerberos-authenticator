...
public class Krb5LoginModule implements LoginModule {
    ...
    // since krb.javax.security.auth.login.LoginContext passes a raw HashMap.
    ...
    private void promptForName(boolean getPasswdFromSharedState)
        ...
        if (doNotPrompt) {
            ...
            try {
                ...
                MessageFormat form = new MessageFormat("Kerberos username [{0}]: ");
    ...
    private void promptForPass(boolean getPasswdFromSharedState)
        ...
        if (doNotPrompt) {
            ...
            try {
                ...
                MessageFormat form = new MessageFormat("Kerberos password for {0}: ");
